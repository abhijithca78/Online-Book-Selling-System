        ...
        <div class="col-lg-8">
            ...
            <div class="table-responsive wishlist-table margin-bottom-none">
                <table class="table">
                    ...
                    $records = mysqli_query($conn,"SELECT my_orders.*, products.* FROM my_orders, products WHERE my_orders.book_id = products.bookid and my_orders.userid='$uid'"); // fetch data from database
